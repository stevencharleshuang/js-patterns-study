...
EventObserver.prototype = {
  ...
  unsubscribe: function(fn) {
    // Filter out from the list whatever matches the callback. If there is no match, the callback gets to stay on the list. The filter returns a new list and reassigns the list of observers.
